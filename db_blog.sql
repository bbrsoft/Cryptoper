...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2024 at 09:30 AM
...
(5, 'Home', 'ce9451229e7f3870c24ba5b5d081bd9b.png');
...
(1, 'About Me', 'Lotto Pools adalah platform daring yang menyediakan layanan lotre dan pengelolaan anggota untuk pemain lotre Singapura dan Hong Kong. Kami menawarkan pengalaman bermain lotre yang menyenangkan dan interaktif dengan fitur-fitur seperti live draw, riwayat hasil, pengelolaan kotak, dan pengecekan nomor secara praktis. Bergabunglah dengan komunitas kami untuk kesempatan memenangkan hadiah menarik setiap hari!');
...
(1, 'lottopools.online', 'lottopools.online', 'Latest Indonesia and World News Today, the Latest Most Complete Daily News Regarding Politics, Economy, Travel, Technology, Automotive, ...', 'lottopools.online', 'c551664b65bad27d6b56ac71bfdd016f.png');
...
(3, 'Manajemen Artikel', '', 'fas fa-fw fa-newspaper', 'N'),
(4, 'Media', '', 'fas fa-fw fa-photo-video', 'Y'),
(5, 'Website', '', 'fas fa-fw fa-home', 'Y'),
(6, 'Member Management', 'admin/user', 'fas fa-fw fa-users', 'Y'),
(7, 'Management 4D', '', 'fas fa-fw fa-dice', 'Y'),
(8, 'Box Management', '', 'fas fa-fw fa-box', 'N'),
(9, 'Logout', 'auth/logout', 'fas fa-fw fa-users', 'Y');
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `role`, `coin`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
(1, '127.0.0.1', 'administrator', '$2y$12$QUM2OeQCZclQqJIhZKKMt.Aq8dA3Y7eIzjtXsyr.xuE0kDjfj8SLS', '', 0, 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1720164030, 1, 'Garsans', 'News', NULL, '0123456789'),
(2, '', 'dev', '$2y$10$QybrAjSQTw.8sCL94e0OMuSVrmJQkY9dBkshO/cbEniq9p5qludfm', 'user', 1200, 'dev@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1720154202, NULL, NULL, NULL, NULL, NULL, NULL);
